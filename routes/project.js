...
module.exports = function(app) {
    ...
    app.post('/project', function (req, res) {
    	console.log("Inside POST -create"+req.body);
    ...
    app.get('/project', function (req, res) {
    	console.log("Inside GET -read"+req.body);
    ...
    app.get('/project/:id', function (req, res) {
    	console.log("Inside GET -project id"+req.body);
    ...
    app.put('/project/:id', function (req, res) {
    	console.log("Inside PUT -update"+req.body);
        Project.findById(req.params.id, function(err, project) {
            if (err) {
                res.json({info: 'error during find project', error: err});
            };
